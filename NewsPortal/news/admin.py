...
admin.site.register(Post, PostTranslationAdmin)  # Не забываем добавить классы
admin.site.register(Category, CategoryTranslationAdmin)  # Не забываем добавить классы
